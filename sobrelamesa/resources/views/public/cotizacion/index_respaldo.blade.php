              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    ...
                    <small class="float-right">Fecha de Cotización: {{$objectEvento[0]->fecha_cotizacion}}</small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-3 invoice-col">
                  ...
                  <address>
                    ...
                    Telefono: {{$objectEvento[0]->celular1}}<br>
                    Email: {{$objectEvento[0]->correo_electronico}}
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-3 invoice-col">
                  ...
                  <br>
                  <b>Fecha de Evento: </b> {{$objectEvento[0]->fecha_evento.' '.$objectEvento[0]->hora_evento}}<br>
                  <b>Fecha de Entrega:</b> {{$objectEvento[0]->fecha_entrega.' '.$objectEvento[0]->hora_entrega}}<br>
                  <b>Fecha de Recolección:</b> {{$objectEvento[0]->fecha_recoleccion.' '.$objectEvento[0]->hora_recoleccion}}
                </div>
                <!-- /.col -->
              </div>
              <!-- /.row -->
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <tr>
                      ...
                      <td>{{'$' . number_format($detailsEvent->precio_renta, 2)}}</td>
