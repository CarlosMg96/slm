                ...
                <div class="footer">
                    <div class="row">
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                          <button id="costo_flete" class="btn btn-sm btn-default" disabled="disabled" style="width: 100%; color: black;"></button>
                        </div>
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                          <button id="costo_montaje" class="btn btn-sm btn-default" disabled="disabled" style="width: 100%; color: black;"></button>
                        </div>
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                          <button id="costo_lavado" class="btn btn-sm btn-default" disabled="disabled" style="width: 100%; color: black;"></button>
                        </div>
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" >
                            <div class="row">
                                <!--<div class="col-sm-6">
    ...
    function details_event(){
        ...
        $.ajax({    
            ...
            success: function (response){                
                ...
                $('#folio_').val(response.responseEvento.fecha_cotizacion);                
...
function efectuar_pago() {
  ...
  Data.append('iva', checkBox.checked);
